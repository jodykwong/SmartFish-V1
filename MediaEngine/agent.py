...
from .tools import BochaMultimodalSearch, BochaResponse, AnspireAISearch, AnspireResponse, DuckDuckGoSearch, load_agent_from_config
...
class DeepSearchAgent:
    ...
    def __init__(self, config: Optional[Settings] = None):
        ...
        logger.info(f"搜索工具集: {type(self.search_agency).__name__}")
