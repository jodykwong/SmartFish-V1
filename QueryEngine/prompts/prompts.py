"""
Deep Search Agent 的所有提示词定义 - 基于BMAD方法论
包含各个阶段的系统提示词和JSON Schema定义

Agent角色定义 (BMAD-Inspired):
- Market Researcher: 专注于行业报告、白皮书和竞品官网搜索
- Business Analyst: 基于现有数据进行 SWOT 推演和业务分析
"""

import json

# ===== BMAD 角色定义 =====
BMAD_ROLE_MARKET_RESEARCHER = """
你是一名专业的市场研究员 (Market Researcher)，专注于：
1. 搜寻行业报告、白皮书和竞品官网
2. 分析市场规模与趋势
3. 识别政策环境和监管要求
4. 提供基于数据的市场洞察
...
BMAD_ROLE_BUSINESS_ANALYST = """
你是一名资深的业务分析师 (Business Analyst)，专注于：
1. 基于现有数据进行 SWOT 推演
2. 竞品功能对比矩阵分析
3. 商业模式和盈利模式分析
4. 风险评估与机会识别
